...
function AboutMeCards(props) {
  return (
    <>
        <div className="border border-green-400 rounded-lg flex flex-col items-center p-5 w-[250px]  hover:bg-gradient-to-r from-green-600 via-green-700 to-green-500 transition-all hover:text-white">
